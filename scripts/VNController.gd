...
func _ready() -> void:
	...
	var packets: Array = _load_twine_json("res://scripts/day1.json")
	if packets.is_empty():
...
func _register_actors() -> void:
	...
	# Scotch and Tofu share one sprite — registered as a single actor "Scotch_Tofu".
	# In Twine, tag passages with "scotch" or "tofu"; both resolve to this actor.
	actor_manager.register_actor({
		"id": "Scotch_Tofu",
		"scale": 1.0,
		"expressions": {
			"neutral": preload("res://actors/scotchtofu/OLD.jpg")
		}
	})
...
#
	#actor_manager.register_actor({
		...
		#"scale": 1.0,
		#"expressions": {
			#"neutral": preload("res://actors/jane/jane_neutral.png")
		#}
	#})
#
	#actor_manager.register_actor({
		...
		#"scale": 1.0,
		#"expressions": {
			#"neutral": preload("res://actors/smith/smith_neutral.png")
		#}
	#})
