...
@onready var nameplate_panel:  PanelContainer = $TextboxPanel/VBox/NameplatePanel
@onready var name_label:       RichTextLabel  = $TextboxPanel/VBox/NameplatePanel/NameLabel
...
func _show_dialogue(packet: Dictionary) -> void:
	...
	var speaker: String = packet.get("speaker", "")
